...
export const ProjectItem = ({ item, index }: ProjectItemProps) => {
  ...
  return (
    ...
    >
      <Link
        href={`${GITHUB_LINK}/${item.githubProjectName}`}
        target="_blank"
        rel="noopener noreferrer"
        className="block"
      >
        <Card className="flex flex-col h-full hover:shadow-lg hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
